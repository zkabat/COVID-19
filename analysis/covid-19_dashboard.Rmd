...
renderPlotly({
  if (input$metric == "Cases") {
    plot_data(data_last(), latest_date, cases_cum, region)
  } else if (input$metric == "Deaths") {
    plot_data(data_last(), latest_date, deaths_cum, region)
  } else if (input$metric == "Recovered"){
    plot_data(data_last(), latest_date, recovered_cum, region)
  }
})
```
...
renderPlotly({
  ...
  if (input$metric == "Cases") {
    plot_data(data_here, latest_date, cases_cum_per_mil, region)
  } else if (input$metric == "Deaths") {
    plot_data(data_here, latest_date, deaths_cum_per_mil, region)
  } else if (input$metric == "Recovered") {
    plot_data(data_here, latest_date, recovered_cum_per_mil, region) 
  }
})
```
...
renderPlotly({
  if (input$metric == "Cases") {
    plot_data(data_last(), latest_date, cases_new, region)
  } else if (input$metric == "Deaths") {
    plot_data(data_last(), latest_date, deaths_new, region)
  } else if (input$metric == "Recovered"){
    plot_data(data_last(), latest_date, recovered_new, region)
  }
})
```
...
renderPlotly({
  ...
  if (input$metric == "Cases") {
    plot_data(data_here, latest_date, cases_new_per_mil, region)
  } else if (input$metric == "Deaths") {
    plot_data(data_here, latest_date, deaths_new_per_mil, region)
  } else if (input$metric == "Recovered") {
    plot_data(data_here, latest_date, recovered_new_per_mil, region) 
  }
})
```
