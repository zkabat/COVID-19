...
plot_data <- function(data, date, var, group_var = NULL, n = 20, plotly = TRUE) {
  date_ <- date
  var <- enquo(var)
...
plot_map <- function(data, var, legend_title) {
  ...
  fig <- fig %>% colorbar(title = legend_title)
  
  map <- fig %>% layout(geo = geo)
...
data <- data %>% 
  mutate(cases_cum_per_100k = round(cases_cum/population*100000, 3),
         ...
         cases_new_smooth_per_100k = round(cases_new_smooth/population*100000, 3),
         deaths_cum_per_100k = round(deaths_cum/population*100000, 6),
         deaths_new_per_100k = round(deaths_new/population*100000, 6),
         deaths_new_smooth_per_100k = round(deaths_new_smooth/population*100000, 6))
...
### New case trend for top 10 countries
...
### New case rate trend for top 10 countries
...
### New death trend for top 10 countries
...
### New death rate trend for top 10 countries
