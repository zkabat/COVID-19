...
<!-- fig <- fig %>% -->
<!--   add_trace( -->
<!--     z = ~cases_cum, color = ~cases_cum, colors = 'Reds', -->
...
fig <- fig %>%
  add_trace(
    z = ~cases_cum_per_100k, color = ~cases_cum_per_100k, colors = 'Reds',
    text = ~country, locations = ~country_code, marker = list(line = l)
  )
fig <- fig %>% colorbar(title = 'Cases per 100k')
