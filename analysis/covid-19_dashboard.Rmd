...
data <- data %>% 
  mutate(cases_cum_per_mil = round(cases_cum/population*1000000, 0),
         cases_new_per_mil = round(cases_new/population*1000000, 0),
         cases_new_smooth_per_mil = 
           round(cases_new_smooth/population*1000000, 0),
         deaths_cum_per_mil = round(deaths_cum/population*1000000, 0),
         deaths_new_per_mil = round(deaths_new/population*1000000, 0),
         deaths_new_smooth_per_mil = 
           round(deaths_new_smooth/population*1000000, 0),
         recovered_cum_per_mil = round(recovered_cum/population*1000000, 0),
         recovered_new_per_mil = round(recovered_new/population*1000000, 0),
         recovered_new_smooth_per_mil = 
           round(recovered_new_smooth/population*1000000, 0))
...
renderPlotly({
  if (input$metric == "Cases") {
    plot_data(data_last(), latest_date, cases_cum, region, input$nbars)
  } else if (input$metric == "Deaths") {
    plot_data(data_last(), latest_date, deaths_cum, region, input$nbars)
  } else if (input$metric == "Recovered"){
    plot_data(data_last(), latest_date, recovered_cum, region, input$nbars)
  }
})
```
...
renderPlotly({
  if (input$metric == "Cases") {
    plot_data(data_last(), latest_date, cases_cum_per_mil, region, input$nbars)
  } else if (input$metric == "Deaths") {
    plot_data(data_last(), latest_date, deaths_cum_per_mil, region, input$nbars)
  } else if (input$metric == "Recovered") {
    plot_data(data_last(), latest_date, recovered_cum_per_mil, region, 
              input$nbars) 
  }
})
```
...
renderPlotly({
  if (input$metric == "Cases") {
    plot_data(data_last(), latest_date, cases_new, region, input$nbars)
  } else if (input$metric == "Deaths") {
    plot_data(data_last(), latest_date, deaths_new, region, input$nbars)
  } else if (input$metric == "Recovered"){
    plot_data(data_last(), latest_date, recovered_new, region, input$nbars)
  }
})
```
...
renderPlotly({
  if (input$metric == "Cases") {
    plot_data(data_last(), latest_date, cases_new_per_mil, region, input$nbars)
  } else if (input$metric == "Deaths") {
    plot_data(data_last(), latest_date, deaths_new_per_mil, region, input$nbars)
  } else if (input$metric == "Recovered") {
    plot_data(data_last(), latest_date, recovered_new_per_mil, region, 
              input$nbars) 
  }
})
```
